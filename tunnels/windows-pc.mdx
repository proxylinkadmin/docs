...
When you rotate WireGuard keys or update settings, click **Update Config** on the tunnel row. This pushes the new config to the PC automatically via the Agent — no manual steps.
